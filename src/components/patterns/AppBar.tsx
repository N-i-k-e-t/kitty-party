...
export function AppBar() {
  ...
  return (
    <header className="sticky top-0 z-30 border-b border-stroke-subtle bg-surface-glass/85 px-saheli-16 py-saheli-16 backdrop-blur-md lg:hidden pt-[max(1rem,env(safe-area-inset-top))]">
